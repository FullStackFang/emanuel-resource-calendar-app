...
export default function ConflictDialog({
  ...
  switch (conflictType) {
    ...
    case 'hard_conflict':
      ...
      message = details.message || 'This conflicts with an existing booking. Save anyway?';
      ...
      <div className="conflict-dialog">
        ...
        <div className={`conflict-dialog-header ${iconClass}`}>
          <div className="conflict-dialog-icon">
            ...
            ) : (conflictType === 'data_changed' || conflictType === 'hard_conflict') ? (
        ...
        <div className="conflict-dialog-footer">
          <button
            ...
            onClick={onClose}
          >
            {(conflictType === 'soft_conflict' || conflictType === 'hard_conflict') ? 'Cancel' : 'Close'}
          </button>
          ...
          {(conflictType === 'soft_conflict' || conflictType === 'hard_conflict') && onConfirm && (
            <button
              className="conflict-dialog-btn conflict-dialog-btn-warning"
              onClick={onConfirm}
            >
              {conflictType === 'hard_conflict' ? 'Save Anyway' : 'Proceed Anyway'}
            </button>
          )}
        </div>
      </div>
