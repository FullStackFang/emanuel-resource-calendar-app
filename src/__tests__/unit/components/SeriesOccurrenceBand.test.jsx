...
describe('SeriesOccurrenceBand', () => {
  ...
  it('SOB-6: conflicts focus compresses non-conflicted chips and makes them inert', () => {
    const onSelectDate = vi.fn();
    ...
    expect(chip('2026-03-10').className).toContain('compressed');
    expect(chip('2026-03-17').className).not.toContain('compressed');

    fireEvent.click(chip('2026-03-10'));
