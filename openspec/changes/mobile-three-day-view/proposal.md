...
- Add a 3-day time grid view: 24-hour scrollable grid at 52px/hour, sticky day headers, today column tint, current-time indicator, all-day chip row, and event blocks positioned by start/end time using the app's outline-over-translucent-wash idiom in Outlook category colors.
