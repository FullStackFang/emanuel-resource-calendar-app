  ...
  useEffect(() => {
    ...
    if (mode === 'create' && prefill) {
      ...
      const mappedData = {
        ...
        reservationStartTime: prefill.reservationStartTime || '',
        reservationEndTime: prefill.reservationEndTime || '',
    ...
    if (onSave) {
      const eventData = {
        ...
        internalEnrichment: {
          ...
          reservationStartMinutes: formData.reservationStartMinutes,
          reservationEndMinutes: formData.reservationEndMinutes,
